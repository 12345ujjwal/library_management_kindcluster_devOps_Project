...
During my internship in Cloud Computing and DevOps, I gained hands-on experience with AWS services such as EC2, S3, and Load Balancing. I worked with DevOps tools including Docker, Jenkins, Kubernetes, Prometheus, and Grafana to build, deploy, and monitor applications. This experience strengthened my understanding of cloud infrastructure, CI/CD pipelines, and containerized environments.
